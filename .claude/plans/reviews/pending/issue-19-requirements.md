---
source: .claude/plans/issue-19-database-upsert/requirements.md
stage: requirements
issue: 19
status: pending_review
staged_at: 2026-01-19T22:10:00-06:00
---
...
1. AFTER import, querying customer "Applebee's" SHALL return exactly 30 linked locations.
2. AFTER import, querying customer "Bojangles" SHALL return exactly 222 linked locations.
3. AFTER import, all locations tagged 'Needs Review' SHALL have a corresponding log entry explaining the issue.
4. AFTER import, all bookings with `crm_status` = 'COMPLETED' SHALL have `status` = 'completed' and `actual_start_time` populated.
