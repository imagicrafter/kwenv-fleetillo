...
const logger = (0, logger_js_1.createContextLogger)('DeleteTestData');
...
async function deleteTestData() {
    ...
    const schema = index_js_1.config.supabase.schema || 'routeiq';
...
// Run the deletion
deleteTestData();
//# sourceMappingURL=delete-test-data.js.map