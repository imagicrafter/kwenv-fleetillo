...
exports.ErrorCodes = {
    ...
    AUTHENTICATION_REQUIRED: {
        ...
        statusCode: errors_1.HttpStatusCode.UNAUTHORIZED,
    ...
    ACCESS_DENIED: {
        ...
        statusCode: errors_1.HttpStatusCode.FORBIDDEN,
        category: errors_1.ErrorCategory.AUTHORIZATION,
        severity: errors_1.ErrorSeverity.MEDIUM,
    },
    ...
    RESOURCE_NOT_FOUND: {
        ...
        statusCode: errors_1.HttpStatusCode.NOT_FOUND,
        category: errors_1.ErrorCategory.RESOURCE,
        severity: errors_1.ErrorSeverity.LOW,
    },
    RESOURCE_ALREADY_EXISTS: {
        code: 'RESOURCE_ALREADY_EXISTS',
        message: 'Resource already exists',
        statusCode: errors_1.HttpStatusCode.CONFLICT,
        category: errors_1.ErrorCategory.RESOURCE,
        severity: errors_1.ErrorSeverity.LOW,
    },
    RESOURCE_CONFLICT: {
    ...
    BUSINESS_RULE_VIOLATION: {
        ...
        statusCode: errors_1.HttpStatusCode.UNPROCESSABLE_ENTITY,
    ...
    QUOTA_EXCEEDED: {
        ...
        statusCode: errors_1.HttpStatusCode.TOO_MANY_REQUESTS,
        category: errors_1.ErrorCategory.BUSINESS,
        severity: errors_1.ErrorSeverity.MEDIUM,
    },
    // ============================================
    ...
    EXTERNAL_SERVICE_ERROR: {
        ...
        statusCode: errors_1.HttpStatusCode.BAD_GATEWAY,
        category: errors_1.ErrorCategory.EXTERNAL,
    ...
    GOOGLEROUTES_MISSING_API_KEY: {
        ...
        statusCode: errors_1.HttpStatusCode.INTERNAL_SERVER_ERROR,
        category: errors_1.ErrorCategory.CONFIGURATION,
        severity: errors_1.ErrorSeverity.CRITICAL,
    },
    GOOGLEROUTES_TIMEOUT: {
        code: 'GOOGLEROUTES_TIMEOUT',
        message: 'Google Routes API request timed out',
        statusCode: errors_1.HttpStatusCode.GATEWAY_TIMEOUT,
        category: errors_1.ErrorCategory.EXTERNAL,
        severity: errors_1.ErrorSeverity.HIGH,
        retry: {
            retryable: true,
    ...
    GOOGLEROUTES_NETWORK_ERROR: {
        ...
        statusCode: errors_1.HttpStatusCode.SERVICE_UNAVAILABLE,
        category: errors_1.ErrorCategory.NETWORK,
        severity: errors_1.ErrorSeverity.HIGH,
        retry: {
            retryable: true,
            maxRetries: 3,
    ...
    ROUTE_GENERATION_FETCH_BOOKING_FAILED: {
        ...
        statusCode: errors_1.HttpStatusCode.INTERNAL_SERVER_ERROR,
        category: errors_1.ErrorCategory.INTERNAL,
        severity: errors_1.ErrorSeverity.MEDIUM,
    },
    ...
    DATABASE_ERROR: {
        ...
        statusCode: errors_1.HttpStatusCode.INTERNAL_SERVER_ERROR,
        category: errors_1.ErrorCategory.DATABASE,
        severity: errors_1.ErrorSeverity.HIGH,
    },
