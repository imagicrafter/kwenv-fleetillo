...
exports.getDriversInActiveJobs = getDriversInActiveJobs;
exports.checkDriverConflicts = checkDriverConflicts;
exports.createDispatchJob = createDispatchJob;
exports.getDispatchJobs = getDispatchJobs;
exports.getDispatchJobById = getDispatchJobById;
exports.executeDispatchJob = executeDispatchJob;
exports.cancelDispatchJob = cancelDispatchJob;
exports.removeDriverFromJob = removeDriverFromJob;
exports.getPendingJobsDue = getPendingJobsDue;
/**
...
async function getDriversInActiveJobs() {
    ...
    try {
        ...
        (data || []).forEach((job) => {
            (job.driver_ids || []).forEach((id) => allDriverIds.add(id));
        });
 ...
 */
async function createDispatchJob(input) {
...
async function executeDispatchJob(jobId) {
    ...
    const finalStatus = failedCount === job.driverIds.length ? 'failed' : 'completed';
...
async function removeDriverFromJob(jobId, driverId) {
    ...
    const updatedDriverIds = job.driverIds.filter((id) => id !== driverId);
