 ...
 */
export type ActivityAction = 'created' | 'updated' | 'completed' | 'started' | 'cancelled' | 'scheduled' | 'status_changed' | 'deleted';
/**
 ...
 */
export declare function rowToActivityLog(row: ActivityLogRow): ActivityLog;
/**
 * Converts a CreateActivityInput to a database row format
 */
export declare function activityInputToRow(input: CreateActivityInput): Partial<ActivityLogRow>;
